...
<body class="hold-transition login-page" background="images/welcome_pg.jpg" style=" background-repeat: no-repeat; background-attachment: fixed; background-size: 100% 100%;">
    <div class="login-box">
