...
<div class="content-wrapper">
        ...
        <div class="col-12">
            ...
            <div class="card card-dark card-outline me-2 ms-2">            
                <div class="card-header d-flex p-0">
                    <h3 class="card-title p-3"><b>ABOUT</b></h3>
                </div><!-- /.card-header -->
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">
                            <div class="introduction ms-3 me-2">
                            <div class="about_heading text-center">COMPANY PROFILE</div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card card-dark card-outline me-2 ms-2">
                <div class="card-header d-flex p-0">
                    <h3 class="card-title p-3"><b>VISION, MISSION, KEYS TO SUCCESS AND VALUES</b></h3>
                </div><!-- /.card-header -->
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">
                            <div class="adminvmg ms-3 me-3">
