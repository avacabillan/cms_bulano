...
@section('content')
  ...
  <div class="row">
    <div class="col-12">
      <a type="button" class="btn btn-primary mt-2 mb-2 me-3" href="{{route('add_client')}}" style="float: right;"><i class="fas fa-plus-circle"></i>Add New Client</a>
      ...
      <a type="button" class="btn btn-primary mt-2 mb-2 me-3" data-toggle="modal" style="float: right;"data-target="#addAssoc"><i class="fas fa-plus-circle"></i> Add New Admin</a>
      <div class="card card-dark card-outline me-3 ms-3">
        <div class="card-header">
          <h3 class="card-title">List of <b>Requestee</b></h3>
        </div><!-- /.card-header -->
        <div class="card-body table-responsive me-2 ms-2" style="height: 300px;">
          <table  id="assoc-list" class="table table-head-fixed yajra-datatable">
            <thead>
              <tr>
