    ...
    <div class="container">
      ...
      <form method="POST" action="{{route('update-reminder',$reminder->id)}}">
        ...
        <div class="row">
          ...
          <div class="form-group col-md-4">
            <strong> Color : </strong>  
            <input class="color form-control"  type="color"  value="{{$reminder->color}}" id="color" name="color">   
         </div>
        </div>
        <div class="row">
          <div class="col-md-4"></div>
          <div class="form-group col-md-4">
            ...
            <input class="date form-control"  type="date"  value="{{$reminder->start}}" id="startdate" name="start_date">   
         </div>
        </div>
        <div class="row">
          <div class="col-md-4"></div>
          <div class="form-group col-md-4">
            ...
            <input class="date form-control"  type="date"  value="{{$reminder->end}}" id="enddate" name="end_date">   
         </div>
        </div>
        <div class="row">
          <div class="col-md-4"></div>
