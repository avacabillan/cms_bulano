      ...
      <table id="clients-list" class="table table-bordered"  style="width:60% ">
        <thead >
          <tr>
            ...
            <th class="Client-th text-dark text-center">Title</th>
        ...
        <tbody>
          @foreach($deadlines as $deadline)
            <tr>
              ...
              <td>
                <center><a  class="btn btn-success btn-sm viewbtn mr-2 " href="{{route('edit-deadline',$deadline->id)}}"  title="View Profile"><i class="fas fa-edit  text-center"></a></i>
                <a  class="btn btn-success btn-sm viewbtn " href="{{route('delete-deadline',$deadline->id)}}"  title="View Profile"><i class="fas fa-trash  text-center"></a></i>
                </center</td>       
            </tr>
          @endforeach
        </tbody>
