<div class="page-content "style="margin: top 160px;">
    <div class="container mt-5" style="height:50%">
        ...
        <table id="files-list" class="table table-bordered"  style="width:100% ">
                ...
                <tbody>
                @foreach($taxFiles as $taxFile)
                    <tr>
                        
                        
                        <td>{{$taxFile->file_name}}</td>
                        <td>{{$taxFile->description}}</td>
                        <td>{{$taxFile->file_type}}</td>
                        ...
                        <td>
                         ...
                         <a  class="btn btn-success btn-sm" href="{{ route('upload.destroy', $taxFile->id) }}" >Archive</a>
