            ...
            <div class="doctor-msg mt-5">
                ...
                <div class="card" id="sender-msg" >
                    ...
                    <div class="card-footer">
                        <form id="Form" action="{{route('associate_composemsg')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('post')
...
<script>
    $(document).ready(function(){
        ...
        $('.user').click(function(){
            ...
            window.history.pushState('', 'New Page Title', '/message-client');
            $.ajax({    
                type: 'get',
                url: "associate_showmsg/"+id,
                data:{ id: id},
            })
            .done(function(data){  
